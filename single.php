          ...
          while(have_posts()) { the_post(); ?>
            <div class="bs-blog-post single"> 
              ...
              <article class="small single">
                <?php
				$id_post = get_the_ID();
				$isbn = get_post_meta( $id_post, 'isbn', true );
				...
				$genres = get_the_terms( $id_post, 'genres' );?>

				<div class="row" style="margin: 30px">
				<div class="col-lg-3"><img src="<?php echo $imgUrl; ?>" width="128" height="202"></div>
				<div class="col-lg-9"><b>Title:</b> <?php echo $getcontent->title; ?><br>
				...
				<div class="col-lg-12"  style="margin-top: 30px"><?php echo $getcontent->description; ?></div>

				<h2 style="margin-top: 30px">Reviews:</h2>

				<?php $reviewsCol = get_post_meta( $id_post, 'reviews', true );

				for ($i = 1; $i <= (int)$reviewsCol; $i++) {
				   $item = $i - 1;
				   $name = get_post_meta( $id_post, 'reviews_'.$item.'_name' );
				   $date = get_post_meta( $id_post, 'reviews_'.$item.'_date' );
				   $text = get_post_meta( $id_post, 'reviews_'.$item.'_text' ); ?>

				<div class="row" style="margin-top: 30px">

					<div class="col-lg-3">
					   <b>Name: </b><?php echo $name[0]; ?><br>
					   <b>Date: </b><?php echo $date[0]; ?>
					</div>
				   <div class="col-lg-9"><?php echo $text[0]; ?></div>
				</div>
			  <?php  } 	?>
